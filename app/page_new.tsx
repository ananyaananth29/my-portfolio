  ...
  return (
    <div className="relative bg-black text-white font-sans scroll-smooth">
      ...
      <section id="hero" className="min-h-screen flex flex-col justify-center items-center text-center pt-32 px-4">
        ...
        <h6 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent mt-4">
        ...
        <p className="text-lg text-gray-300 mt-4">Currently on an F-1 visa | <span className="text-purple-300">eligible for CPT/OPT and open to future sponsorship.</span></p>
              ...
              <ul className="space-y-3">
                ...
                >
                  <li className="bg-white/10 p-3 rounded-lg flex items-center gap-4 hover:bg-white/20 transition">
                    ...
                    <div>
                      <p className="font-semibold">IBM Artificial Intelligence Certificate</p>
                ...
                >
                  <li className="bg-white/10 p-3 rounded-lg flex items-center gap-4 hover:bg-white/20 transition">
                    <div className="bg-white p-2 rounded">
                      <Image src="/Ansible-Logo.avif" alt="Ansible Certificate" width={32} height={32} />
                    </div>
                    <div>
